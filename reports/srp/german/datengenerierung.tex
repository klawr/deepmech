...
Für die jeweilige Interaktion wird die Funktion \code{setMouseCallback} auf den erzeugten \code{namedWindow} angewendet, wobei eine \code{draw}-Funktion aufgerufen wird, die es ermöglicht, Mausereignisse zu erkennen und darauf zu reagieren.
