...
Diese Beziehung wird in Gleichung~\eqref{eq:universal_approx} \footnote{In der Literatur gibt es oft einen Bias innerhalb der Summe.
Gemäß der Konvention, dem Eingangsvektor $x$ eine 1 voranzustellen, ist diese immer enthalten.
Bitte beachten Sie, dass dies mathematisch gesehen dasselbe ist, aber nur eine Frage des Geschmacks.} gezeigt.
