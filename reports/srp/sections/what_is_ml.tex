...
An optimal setting of hyper-parameters is an important task which is hard to automate and therefore focus of a lot of research\footnote{There are algorithms to adjust the learning rate, namely \name{AdaGrad} \cite{Duchi2010} and derived algorithms.} and is the main topic of chapter \ref{ch:hyper_parameter_tuning}.
