...
A Jupyter notebook testing the performance of this method can be viewed at \aka{https://github.com/klawr/deepmech/blob/master/reports/sep/notebooks/2.1.1-scanning\_an\_image.ipynb}.
...
The respective notebook containing the code for this process can be viewed at \aka{https://github.com/klawr/deepmech/blob/wip/sep/reports/sep/notebooks/2.2.1-constraint\_data\_gen.ipynb}.
...
The notebook doing this operation can be viewed at \aka{https://github.com/klawr/deepmech/blob/wip/sep/reports/sep/notebooks/2.2.2-connecting\_nodes.ipynb}.
...
The model is created using the functional API of \name{Keras}, which has no real impact on the result, but is just another way of defining models\footnote{See \aka{https://keras.io/guides/functional\_api/}.}.
...
A pipeline of this operation can be reviewed at \aka{https://github.com/klawr/deepmech/blob/wip/sep/reports/sep/notebooks/2.2.5-combining\_node\_constraints.ipynb}.
...
The trained weights and biases are contained in \name{group1-shard1of1.bin}\footnote{Instructions on how to import a Keras model into Tensorflow.js can be viewed at \aka{https://www.tensorflow.org/js/tutorials/conversion/import\_keras}.}.
...
The full file can be reviewed at \aka{https://raw.githubusercontent.com/klawr/deepmech/master/reports/sep/code/old/crop.js}.
...
It can be viewed at \aka{https://github.com/klawr/deepmech/blob/master/reports/sep/notebooks/2.3.1-nodejs\_implementation.ipynb}.
...
It is designed to easily create 2D mechanical linkages.
The results can be rendered on a 2D canvas using the \name{g2} graphics library\cite{goessner2021}.
...
Additionally, \name{mec2} provides a custom HTML element, which allows for an easy implementation into web pages\footnote{For more information about custom HTML elements see \aka{https://developer.mozilla.org/en-US/docs/Web/Web\_Components/Using\_custom\_elements}.}.
