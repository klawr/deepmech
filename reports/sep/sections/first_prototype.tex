...
By using \name{ijavascript} and the \name{conda} package of Node.js integrated into a Jupyter Notebook, the result can be viewed at \aka{https://github.com/klawr/deepmech/blob/master/reports/sep/notebooks/2.3.1-nodejs\_implementation.ipynb}.
