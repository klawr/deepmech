...
A Progressive Web App (PWA)\footnote{See \aka{https://developer.mozilla.org/en-US/docs/Web/Progressive_web_apps}.} is created to nest this new functionality into an application.
