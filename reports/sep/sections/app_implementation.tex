...
The Windows Presentation Foundation is a subsystem that can be used to create user interfaces for windows applications.
It offers a \name{WebView} which can be used to embed the web application fully into an offline application. % TODO some context about WebView.
