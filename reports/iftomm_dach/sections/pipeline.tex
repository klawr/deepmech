...
Die daraus entstandenen Schnitte werden verformt um einheitliche Maße zu haben.
...
Die daraus gewonnene Information kann dann in das von \name{mec-2} genutzt JSON Format überführt werden und der Mechanismus kann dargestellt werden.
