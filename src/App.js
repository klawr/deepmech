...
const DeepmechCanvas = React.lazy(() =>
  import("./Components/Deepmech/DeepmechCanvas")
);
...
const placeholder = {
  ply: g2(),
  mec: g2()
    .beg(begSimView(ref._interactor.view))
    .use({
      grp: () => ({
  ...
  return (
    <MuiThemeProvider theme={UI.darkmode ? darkTheme : lightTheme}>
      <div className={classes.root}>
        ...
        <MuiThemeProvider
          theme={deepmech.active || UI.darkmode ? darkTheme : lightTheme}
        >
