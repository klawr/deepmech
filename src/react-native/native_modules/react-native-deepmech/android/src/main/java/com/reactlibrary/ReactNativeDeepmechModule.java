...
public class ReactNativeDeepmechModule extends ReactContextBaseJavaModule {
    ...
    public ReactNativeDeepmechModule(ReactApplicationContext reactContext) {
        ...
        //  this.symbol_detector = Module.load(assetFilePath(reactContext, "symbol_detector.pth"));
    }
    ...
    public void sample(String str, Callback cb) {
        ...
        // final Module module = Module.load(assetFilePath(this, "symbol_detector.pth"));

        // TODO: Implement some actually useful functionality
        cb.invoke(str + "world" + String.valueOf(Height));
    }
