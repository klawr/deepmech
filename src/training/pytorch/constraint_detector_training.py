...
from constraint_detector_model import ConstraintDetector
from spot import Spot
from symbol_detector_dataset import SymbolDataSet

annotation_file = path.join("data", "iftomm_dach_interim_023", "config.json")
...
model = ConstraintDetector().to(device)
...
print("Done!")
model_path = "models/constraint_detector.pth"
